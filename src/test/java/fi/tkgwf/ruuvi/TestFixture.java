...
public class TestFixture {
  ...
  public static String getDataFormat3Message() {
    ...
    //                                     |                                   |     |  |  |
    // |     |     |     |     |     |
    return "> 04 3E 21 02 01 03 01 FF EE DD CC BB AA 15 02 01 06 11 FF 99 04 03 49 16 0E BE F8"
        + " 00 05 FF EA 03 E1 0B BF B4";
  }

  public static String getIBeaconMessage() {
    //
    //                                     MAC address (6 bytes)               Manufacturer ID
    // 0x004C
    //                                     |                                   |     Type
    // (iBeacon)
    //                                     |                                   |     |  Length
    //                                     |                                   |     |  |  UUID
    // (16 bytes)                                 Major (2 bytes)
    //                                     |                                   |     |  |  |
    //                                           |     Minor (2 bytes)
    //                                     |                                   |     |  |  |
    ...
    //                                     |                                   |     |  |  |
    //                                           |     |     |
    return "> 04 3E 21 02 01 03 01 FF EE DD CC BB AA 1E 02 01 06 1A FF 4C 00 02 15 FD A5 06 93"
        + " A4 E2 4F B1 AF CF C6 EB 07 64 78 25 00 01 00 02 C5";
  }
  ...
  public static String getEddystoneUIDMessage() {
    ...
    //                                     |                             |  |  |     |  |  |
    // |  |  |                             |                 |
    return "> 04 3E 21 02 01 03 01 FF EE DD CC BB AA 1F 02 01 06 03 03 AA FE 17 16 AA FE 00 93"
        + " 9E 5D 61 E6 66 21 DA 7C A6 30 0E D1 45 67 3A 89 00 00";
  }
  ...
  public static String getEddystoneTMLMessage() {
    ...
    //                                     |                             |  |  |     |  |  |
    // |  |  |     |     |           |
    return "> 04 3E 21 02 01 03 01 FF EE DD CC BB AA 1A 02 01 06 03 03 AA FE 11 17 AA FE 20 00"
        + " 0B B8 19 00 00 00 03 E8 00 00 27 10";
  }
  ...
  public static void setClockToMilliseconds(final Supplier<Long> timestampSupplier) {
    try {
      ...
      var clock =
          Clock.fixed(Instant.ofEpochMilli(timestampSupplier.get()), ZoneId.systemDefault());
