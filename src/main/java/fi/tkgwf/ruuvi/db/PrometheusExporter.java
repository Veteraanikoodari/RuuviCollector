...
public final class PrometheusExporter implements RuuviDBConnection {
  ...
  private static <C extends SimpleCollector, B extends SimpleCollector.Builder<B, C>> C buildGauge(
      String name, String helpText, B builder) {
    return builder
        .namespace(NAMESPACE)
        .name(name)
        .help(helpText)
  ...
  public void save(EnhancedRuuviMeasurement measurement) {
    ...
    String dataFormat =
        Optional.ofNullable(measurement.getDataFormat()).map(String::valueOf).orElse("unknown");
